...
To get both Jupyter and Python, download and install the Anaconda distribution ([link](https://www.anaconda.com/products/individual)). Here is a Jupyter Notebook that shows how to use Python to draw the diagrams and do the computations from an introductory applied statistics course: [Statistics-I-using-Python.ipynb](Statistics-I-using-Python.ipynb) [Here](Statistics-I-using-Python.html) is the notebook exported to an html file. If you prefer running Python in Spyder (also included in the Anaconda distribution), you can copy the Python code in the grey boxes from the html file.  Books on using Python to do statistical analysis:
