...
Luc Hens (Last updated on 28 November 2024)
...
* A good dictionary. The on-line Merriam-Webster dictionary ([link](https://www.merriam-webster.com)) is fine; bookmark it in your browser. McCloskey (2000, p. 26) recommends *Webster's New World Dictionary of the American Language*. ISBN 978-0743470698; available [here](https://www.amazon.de/Websters-New-World-Dictionary/dp/1476705046) for about 5 euro. If you have a Mac, the *Oxford Dictionary of English* is installed as the Dictionary app. If you write in Dutch,  *Algemeen Nederlands Woordenboek* ([link](https://anw.ivdnt.org/)) is available on-line, and so is  *Woordenlijst* (“*Het Groene Boekje*”, [link](https://woordenlijst.org)) by Taalunie; bookmark them in your browser. 
...
- ``Appendix A: Computing in R’’ from Gelman, A., Hill, J., and Vehtari, A. (2020). *Regression and Other Stories*. Cambridge University Press, s.l. Available in the VUB library, call number: 311.17 G GELM 2021. Appendix A is available on-line [here](https://avehtari.github.io/ROS-Examples/Regression_and_Other_Stories_Appendix_A.pdf).
