...
To get both Jupyter Notebook and Python, download and install the Anaconda distribution ([link](https://www.anaconda.com/products/individual)). I made a Jupyter Notebook that shows how to use Python to draw the diagrams and do the computations from an introductory applied statistics course:  [here](https://nbviewer.org/urls/luc-hens.github.io/Statistics-I-using-Python.ipynb#) you can view the notebook; click [here](Statistics-I-using-Python.ipynb) to download the notebook. If you prefer running Python in Spyder (an integrated development environment for programming in Python, also included in the Anaconda distribution and covered in the Business Information Systems / Bedrijfsinformatica courses), copy the Python code from the grey boxes in the [notebook viewer](https://nbviewer.org/urls/luc-hens.github.io/Statistics-I-using-Python.ipynb#).  Books on using Python to do statistical analysis:
