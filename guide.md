...
To get both Jupyter and Python, download and install the Anaconda distribution ([link](https://www.anaconda.com/products/individual)). I made a Jupyter Notebook that shows how to use Python to draw the diagrams and do the computations from an introductory applied statistics course.  [Here](Statistics-I-using-Python.html) you can view the notebook exported to an html file. [Here](Statistics-I-using-Python.ipynb) you can download the Jupyter notebook. If you prefer running Python in Spyder (an integrated development environment for programming in Python, also included in the Anaconda distribution and covered in the Business Information Systems / Bedrijfsinformatica courses), copy the Python code from the grey boxes in the html file.  Books on using Python to do statistical analysis:
